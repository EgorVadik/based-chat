    ...
    <div className={cn('w-full shrink-0', className)}>
      <div className='mx-auto max-w-3xl px-4 pb-4'>
            ...
            <div className='flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between'>
              <div className='flex min-w-0 items-center gap-2'>
                ...
                <Button
                  ...
                  disabled={
                    disabled || isSubmitting || (!canSend && !isStreaming)
                  }
                  className={cn(
              ...
              <div className='flex min-w-0 flex-wrap items-center gap-2 sm:flex-1 sm:justify-end'>
                  ...
                  <TooltipTrigger
                    render={
                      <Button
                        ...
                        className={cn(
                          'h-9 min-w-25 flex-1 justify-center rounded-full border px-3 text-[13px] transition-all sm:h-8 sm:min-w-0 sm:flex-none',
                          isWebSearchEnabled
                    ...
                    <DropdownMenuTrigger
                      render={
                        <Button
                          ...
                          variant='outline'
                          size='sm'
                          className='h-9 min-w-27 flex-1 justify-center rounded-full border-border/60 bg-background/35 px-3 text-[13px] text-muted-foreground transition-all hover:border-border hover:bg-background/55 hover:text-foreground sm:h-8 sm:min-w-0 sm:flex-none'
                ...
                <Button
                  ...
                  variant='outline'
                  size='sm'
                  className='h-9 min-w-24 flex-1 justify-center rounded-full border-border/60 bg-background/35 px-3 text-[13px] text-muted-foreground transition-all hover:border-border hover:bg-background/55 hover:text-foreground disabled:opacity-40 sm:h-8 sm:min-w-0 sm:flex-none'
                  onClick={() => fileInputRef.current?.click()}
                  disabled={
                    isSubmitting || isStreaming || !canAttachToCurrentModel
                  }
                >
        ...
        <p className='mt-2 text-center text-[11px] text-muted-foreground/50'>
          Based Chat may produce inaccurate information. Verify important
          details.
        </p>
      </div>
    </div>
