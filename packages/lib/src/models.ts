...
/**
 * Get the provider icon URL for the given theme.
 * - "dark" theme → use "light" icons (light icons on dark background)
 * - "light" theme → use "dark" icons (dark icons on light background)
 */
export function getProviderIconUrl(
  provider: string,
  theme: 'light' | 'dark' = 'dark',
): string | null {
  const iconId = PROVIDER_ICON_IDS[provider]
...
const DEFAULT_MODELS: Model[] = [
  ...
  },
  {
    ...
    provider: 'Anthropic',
    description:
      'Fast, efficient Claude tier for real-time reasoning and agent tasks',
  ...
  },
  {
    ...
    provider: 'OpenAI',
    description:
      'Earlier GPT-5 generation with multimodal reasoning and PDF support',
  ...
  },
  {
    ...
    provider: 'OpenAI',
    description:
      'Core GPT-5 model for multimodal reasoning and general-purpose use',
    pricing: { input: 1.25, output: 10 },
    capabilities: ['image', 'reasoning', 'pdf'],
    isFavorite: true,
    isLegacy: true,
  ...
  },
  {
    ...
    provider: 'OpenAI',
    description:
      "OpenAI's image generation model with text, image, and file inputs",
  ...
  },
  {
    ...
    provider: 'Z.ai',
    description:
      'Multimodal model for visual understanding, documents, and charts',
  ...
  },
  {
    ...
    provider: 'Z.ai',
    description:
      'Multimodal MoE model for visual understanding and complex tasks',
